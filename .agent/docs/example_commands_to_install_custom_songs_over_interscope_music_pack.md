# Installing Custom Songs Over the Interscope Music Pack

This document provides step-by-step, self-contained pipeline commands to replace all 7 songs
in the official Interscope DLC music pack with custom community songs from BeatSaver.
...
```
CountingStars, DnaLamar, DontCha, PartyRockAnthem, Rollin, Sugar, TheSweetEscape
```
...
## Target: Interscope Official DLC Pack

- **Pack key**: `interscope`
- **Pack bundle**: `interscope_pack_assets_all_c30f1bc42a5cbd3dd316d7debf9926ef.bundle`
- **7 songs** (each with 5 difficulties: Easy, Normal, Hard, Expert, ExpertPlus):
...
```bash
# 1. Counting Stars → [YOUR CUSTOM SONG HERE]
...
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target CountingStars     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 2. DNA. → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target DnaLamar     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 3. Don't Cha → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target DontCha     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 4. Party Rock Anthem → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target PartyRockAnthem     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 5. Rollin' (Air Raid Vehicle) → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Rollin     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 6. Sugar → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Sugar     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 7. The Sweet Escape → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target TheSweetEscape     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```
...
The song slot IDs and difficulty modes for the Interscope pack are defined in:
