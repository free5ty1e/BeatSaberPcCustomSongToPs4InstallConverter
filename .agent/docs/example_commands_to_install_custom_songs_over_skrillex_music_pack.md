# Installing Custom Songs Over the Skrillex Music Pack

This document provides step-by-step, self-contained pipeline commands to replace all 8 songs
in the official Skrillex DLC music pack with custom community songs from BeatSaver.
...
```
Bangarang, Butterflies, DontGo, FirstOfTheYear, RaggaBomb, RockNRoll, ScaryMonstersAndNiceSprites, TheDevilsDen
```
...
## Target: Skrillex Official DLC Pack

- **Pack key**: `skrillex`
- **Pack bundle**: `skrillex_pack_assets_all_940d7944e80112156c32d45e559610f8.bundle`
...
```bash
# 1. Bangarang → [YOUR CUSTOM SONG HERE]
...
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Bangarang     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 2. Butterflies → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Butterflies     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 3. Don't Go → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target DontGo     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 4. First of the Year → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target FirstOfTheYear     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 5. Ragga Bomb → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target RaggaBomb     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 6. Rock 'n' Roll → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target RockNRoll     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 7. Scary Monsters and Nice Sprites → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target ScaryMonstersAndNiceSprites     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 8. The Devil's Den → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target TheDevilsDen     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```
...
The song slot IDs and difficulty modes for the Skrillex pack are defined in:
