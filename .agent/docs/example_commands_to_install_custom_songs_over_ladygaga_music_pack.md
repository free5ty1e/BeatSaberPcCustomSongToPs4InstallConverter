# Installing Custom Songs Over the Lady Gaga Music Pack

This document provides step-by-step, self-contained pipeline commands to replace all 10 songs
in the official Lady Gaga DLC music pack with custom community songs from BeatSaver.
...
```
Alejandro, BadRomance, BornThisWay, JustDance, Paparazzi, PokerFace, RainOnMe, StupidLove, Telephone, TheEdgeOfGlory
```
...
## Target: Lady Gaga Official DLC Pack

- **Pack key**: `ladygaga`
- **Pack bundle**: `ladygaga_pack_assets_all_94fdc48d903336ebaaac1fe70a59345d.bundle`
...
```bash
# 1. Alejandro → [YOUR CUSTOM SONG HERE]
...
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Alejandro     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 2. Bad Romance → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target BadRomance     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 3. Born This Way → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target BornThisWay     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 4. Just Dance → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target JustDance     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 5. Paparazzi → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Paparazzi     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 6. Poker Face → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target PokerFace     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 7. Rain On Me → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target RainOnMe     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 8. Stupid Love → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target StupidLove     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 9. Telephone → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Telephone     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 10. The Edge Of Glory → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target TheEdgeOfGlory     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```
...
The song slot IDs and difficulty modes for the Lady Gaga pack are defined in:
