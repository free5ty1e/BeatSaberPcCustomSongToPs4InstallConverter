# Installing Custom Songs Over the The Weeknd Music Pack

This document provides step-by-step, self-contained pipeline commands to replace all 12 songs
in the official The Weeknd DLC music pack with custom community songs from BeatSaver.
...
```
BlindingLights, CantFeelMyFace, DieForYou, HowDoIMakeYouLoveMe, IFeelItComing, LessThanZero, PrayForMe, Sacrifice, SaveYourTears, Starboy, TakeMyBreath, TheHills
```
...
## Target: The Weeknd Official DLC Pack

- **Pack key**: `theweeknd`
- **Pack bundle**: `theweeknd_pack_assets_all_ebe0e37816bd9fa171c3e96a2220190a.bundle`
- **12 songs** (each with 5 difficulties: Easy, Normal, Hard, Expert, ExpertPlus):
...
```bash
# 1. Blinding Lights → [YOUR CUSTOM SONG HERE]
...
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target BlindingLights     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 2. Can't Feel My Face → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target CantFeelMyFace     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 3. Die For You (Remix) → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target DieForYou     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 4. How Do I Make You Love Me? → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target HowDoIMakeYouLoveMe     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 5. I Feel It Coming → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target IFeelItComing     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 6. Less Than Zero → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target LessThanZero     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 7. Pray For Me → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target PrayForMe     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 8. Sacrifice → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Sacrifice     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 9. Save Your Tears → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target SaveYourTears     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 10. Starboy → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Starboy     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 11. Take My Breath → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target TakeMyBreath     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 12. The Hills → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target TheHills     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```
...
The song slot IDs and difficulty modes for the The Weeknd pack are defined in:
