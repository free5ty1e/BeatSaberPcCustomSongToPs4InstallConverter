# Installing Custom Songs Over the Fall Out Boy Music Pack

This document provides step-by-step, self-contained pipeline commands to replace all 8 songs
in the official Fall Out Boy DLC music pack with custom community songs from BeatSaver.
...
```
Centuries, DanceDance, IDontCare, Immortals, Irresistible, MySongsKnow, ThisAintAScene, ThnksFrThMmrs
```
...
## Target: Fall Out Boy Official DLC Pack

- **Pack key**: `falloutboy`
- **Pack bundle**: `falloutboy_pack_assets_all_226ce29ae7b8e4e8ae36153d2186922f.bundle`
...
```bash
# 1. Centuries → [YOUR CUSTOM SONG HERE]
...
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Centuries     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 2. Dance, Dance → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target DanceDance     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 3. I Don't Care → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target IDontCare     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 4. Immortals → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Immortals     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 5. Irresistible → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Irresistible     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 6. My Songs Know What You Did In The Dark → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target MySongsKnow     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 7. This Ain't A Scene, It's An Arms Race → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target ThisAintAScene     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 8. Thnks fr th Mmrs → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target ThnksFrThMmrs     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```
...
The song slot IDs and difficulty modes for the Fall Out Boy pack are defined in:
