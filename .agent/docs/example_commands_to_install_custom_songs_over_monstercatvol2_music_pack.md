# Installing Custom Songs Over the Monstercat Vol. 2 Music Pack

This document provides step-by-step, self-contained pipeline commands to replace all 12 songs
in the official Monstercat Vol. 2 DLC music pack with custom community songs from BeatSaver.
...
```
Accelerate, Dabadabadabadaba, DeadManWalking, Endgame, FinalBoss, MemoryBank, Mercenary, Pump, Rad, RIOT, ThronesOfBlood, WakeUp
```
...
## Target: Monstercat Vol. 2 Official DLC Pack

- **Pack key**: `monstercatvol2`
- **Pack bundle**: `monstercatvol2_pack_assets_all_6332e520682f2cf1a67bcdd44ce791ec.bundle`
...
```bash
# 1. Accelerate → [YOUR CUSTOM SONG HERE]
...
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Accelerate     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 2. DABADABADABADABA → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Dabadabadabadaba     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 3. Dead Man Walking → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target DeadManWalking     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 4. Endgame → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Endgame     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 5. Final Boss → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target FinalBoss     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 6. Memory Bank → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target MemoryBank     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 7. Mercenary → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Mercenary     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 8. Pump → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Pump     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 9. RAD → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Rad     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 10. RIOT → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target RIOT     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 11. Thrones of Blood → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target ThronesOfBlood     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 12. Wake Up → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target WakeUp     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```
...
The song slot IDs and difficulty modes for the Monstercat Vol. 2 pack are defined in:
