# Installing Custom Songs Over the Queen Music Pack

This document provides step-by-step, self-contained pipeline commands to replace all 11 songs
in the official Queen DLC music pack with custom community songs from BeatSaver.
...
```
AnotherOneBitesTheDust, BohemianRhapsody, CrazyLittleThingCalledLove, DontStopMeNow, IWantItAll, KillerQueen, OneVision, SomebodyToLove, StoneColdCrazy, WeAreTheChampions, WeWillRockYou
```
...
## Target: Queen Official DLC Pack

- **Pack key**: `queen`
- **Pack bundle**: `queen_pack_assets_all_d70de03c84414bd1751375eedf2c6a77.bundle`
...
```bash
# 1. Another One Bites The Dust → [YOUR CUSTOM SONG HERE]
...
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target AnotherOneBitesTheDust     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 2. Bohemian Rhapsody → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target BohemianRhapsody     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 3. Crazy Little Thing Called Love → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target CrazyLittleThingCalledLove     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 4. Don't Stop Me Now → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target DontStopMeNow     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 5. I Want It All → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target IWantItAll     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 6. Killer Queen → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target KillerQueen     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 7. One Vision → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target OneVision     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 8. Somebody To Love → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target SomebodyToLove     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 9. Stone Cold Crazy → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target StoneColdCrazy     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 10. We Are The Champions → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target WeAreTheChampions     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 11. We Will Rock You → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target WeWillRockYou     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```
...
The song slot IDs and difficulty modes for the Queen pack are defined in:
