# Installing Custom Songs Over the Soundtrack Vol. 3 Music Pack

This document provides step-by-step, self-contained pipeline commands to replace all 6 songs
in the official Soundtrack Vol. 3 DLC music pack with custom community songs from BeatSaver.
...
```
BurningSands, FullCharge, GiveALittleLove, Immortal, Origins, ReasonForLiving
```
...
## Target: Soundtrack Vol. 3 Official DLC Pack

- **Pack key**: `ostvol3`
- **Pack bundle**: `ostvol3_pack_assets_all_9dbecd664115a79f917a565963a09b93.bundle`
...
```bash
# 1. Burning Sands → [YOUR CUSTOM SONG HERE]
...
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target BurningSands     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 2. Full Charge → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target FullCharge     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 3. Give a Little Love → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target GiveALittleLove     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 4. Immortal → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Immortal     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 5. Origins → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Origins     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 6. Reason For Living → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target ReasonForLiving     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```
...
The song slot IDs and difficulty modes for the Soundtrack Vol. 3 pack are defined in:
