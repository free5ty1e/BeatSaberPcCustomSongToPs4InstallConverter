# Installing Custom Songs Over the Linkin Park Music Pack

This document provides step-by-step, self-contained pipeline commands to replace all 11 songs
in the official Linkin Park DLC music pack with custom community songs from BeatSaver.
...
```
BleedItOut, BreakingTheHabit, Faint, GivenUp, InTheEnd, NewDivide, Numb, OneStepCloser, Papercut, SomewhereIBelong, WhatIveDone
```
...
## Target: Linkin Park Official DLC Pack

- **Pack key**: `linkinpark`
- **Pack bundle**: `linkinpark_pack_assets_all_8972ec97e0ea56fa799873f31c2742b1.bundle`
...
```bash
# 1. Bleed It Out → [YOUR CUSTOM SONG HERE]
...
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target BleedItOut     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 2. Breaking the Habit → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target BreakingTheHabit     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 3. Faint → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Faint     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 4. Given Up → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target GivenUp     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 5. In the End → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target InTheEnd     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 6. New Divide → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target NewDivide     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 7. Numb → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Numb     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 8. One Step Closer → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target OneStepCloser     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 9. Papercut → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Papercut     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 10. Somewhere I Belong → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target SomewhereIBelong     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 11. What I've Done → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target WhatIveDone     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```
...
The song slot IDs and difficulty modes for the Linkin Park pack are defined in:
