# Installing Custom Songs Over the Daft Punk Music Pack

This document provides step-by-step, self-contained pipeline commands to replace all 10 songs
in the official Daft Punk DLC music pack with custom community songs from BeatSaver.
...
```
AroundTheWorld, AroundTheWorldHarderBetterFasterStronger, DaFunkDaftendirekt, GetLucky, HarderBetterFasterStronger, LoseYourselfToDance, OneMoreTime, PrimeTimeOfYourLifeBrainwasherRollinAliveLive2007, Technologic, VeridisQuo
```
...
## Target: Daft Punk Official DLC Pack

- **Pack key**: `daftpunk`
- **Pack bundle**: `daftpunk_pack_assets_all_9855164048e362e6d374087b9b96851c.bundle`
...
```bash
# 1. Around The World → [YOUR CUSTOM SONG HERE]
...
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target AroundTheWorld     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 2. Around The World / Harder Better Faster Stronger → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target AroundTheWorldHarderBetterFasterStronger     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 3. Da Funk / Daftendirekt → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target DaFunkDaftendirekt     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 4. Get Lucky → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target GetLucky     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 5. Harder, Better, Faster, Stronger → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target HarderBetterFasterStronger     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 6. Lose Yourself To Dance → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target LoseYourselfToDance     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 7. One More Time → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target OneMoreTime     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 8. Prime Time of Your Life → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target PrimeTimeOfYourLifeBrainwasherRollinAliveLive2007     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 9. Technologic → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Technologic     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 10. Veridis Quo → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target VeridisQuo     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```
...
The song slot IDs and difficulty modes for the Daft Punk pack are defined in:
