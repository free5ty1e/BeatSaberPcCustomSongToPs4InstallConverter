# Installing Custom Songs Over the Hip Hop Music Pack

This document provides step-by-step, self-contained pipeline commands to replace all 9 songs
in the official Hip Hop DLC music pack with custom community songs from BeatSaver.
...
```
AllEyezOnMe, Anaconda, GinAndJuice, Godzilla, HeyYA, Hypnotize, NuthinButAGThang, TheMessage, TheWoo
```
...
## Target: Hip Hop Official DLC Pack

- **Pack key**: `hiphop`
- **Pack bundle**: `hiphop_pack_assets_all_113a326224ae04d1a3e95d6be298cdec.bundle`
...
```bash
# 1. All Eyez On Me → [YOUR CUSTOM SONG HERE]
...
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target AllEyezOnMe     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 2. Anaconda → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Anaconda     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 3. Gin and Juice → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target GinAndJuice     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 4. Godzilla → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Godzilla     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 5. Hey Ya! → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target HeyYA     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 6. Hypnotize → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Hypnotize     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 7. Nuthin' But A "G" Thang → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target NuthinButAGThang     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 8. The Message → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target TheMessage     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 9. The Woo → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target TheWoo     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```
...
The song slot IDs and difficulty modes for the Hip Hop pack are defined in:
