# Installing Custom Songs Over the BTS Music Pack

This document provides step-by-step, self-contained pipeline commands to replace all 12 songs
in the official BTS DLC music pack with custom community songs from BeatSaver.
...
```
BloodSweatAndTears, BoyWithLuv, BurningUp, Dionysus, Dna, Dope, Dynamite, FakeLove, Idol, MicDrop, NotToday, Ugh
```
...
## Target: BTS Official DLC Pack

- **Pack key**: `bts`
- **Pack bundle**: `bts_pack_assets_all_afc090dc65861e4430777fbe496d5a7e.bundle`
...
```bash
# 1. Blood Sweat & Tears → [YOUR CUSTOM SONG HERE]
...
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target BloodSweatAndTears     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 2. Boy With Luv → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target BoyWithLuv     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 3. Burning Up → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target BurningUp     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 4. Dionysus → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Dionysus     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 5. DNA → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Dna     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 6. Dope → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Dope     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 7. Dynamite → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Dynamite     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 8. FAKE LOVE → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target FakeLove     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 9. IDOL → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Idol     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 10. MIC Drop → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target MicDrop     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 11. Not Today → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target NotToday     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 12. UGH! → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Ugh     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```
...
The song slot IDs and difficulty modes for the BTS pack are defined in:
