# Installing Custom Songs Over the Rocket League Music Pack

This document provides step-by-step, self-contained pipeline commands to replace all 6 songs
in the official Rocket League DLC music pack with custom community songs from BeatSaver.
...
```
Glide, LuvUNeedU, Play, RockIt, Shiawase, TestMe
```
...
## Target: Rocket League Official DLC Pack

- **Pack key**: `rocketleague`
- **Pack bundle**: `rocketleague_pack_assets_all_13c8131ec931087ef7f9b8e4824491b9.bundle`
...
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Glide     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 2. Luv U Need U → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target LuvUNeedU     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 3. Play → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Play     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 4. Rock It → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target RockIt     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 5. Shiawase → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Shiawase     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 6. Test Me → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target TestMe     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```
...
The song slot IDs and difficulty modes for the Rocket League pack are defined in:
