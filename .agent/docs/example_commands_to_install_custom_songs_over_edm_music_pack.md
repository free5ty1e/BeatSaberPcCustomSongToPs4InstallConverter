# Installing Custom Songs Over the EDM Music Pack

This document provides step-by-step, self-contained pipeline commands to replace all 10 songs
in the official EDM DLC music pack with custom community songs from BeatSaver.
...
```
Alone, Animals, Freestyler, GhostsNStuff, Icarus, Sandstorm, StayTheNight, TheRockafellerSkank, WaitingAllNight, Witchcraft
```
...
## Target: EDM Official DLC Pack

- **Pack key**: `edm`
- **Pack bundle**: `edm_pack_assets_all_fd5b5a9f58abd096dc4c96383aec27b5.bundle`
...
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Alone     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 2. Animals → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Animals     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 3. Freestyler → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Freestyler     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 4. Ghosts 'n' Stuff → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target GhostsNStuff     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 5. Icarus → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Icarus     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 6. Sandstorm → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Sandstorm     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 7. Stay The Night → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target StayTheNight     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 8. The Rockafeller Skank → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target TheRockafellerSkank     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 9. Waiting All Night → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target WaitingAllNight     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 10. Witchcraft → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Witchcraft     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```
...
The song slot IDs and difficulty modes for the EDM pack are defined in:
