# Installing Custom Songs Over the Linkin Park Vol. 2 Music Pack

This document provides step-by-step, self-contained pipeline commands to replace all 8 songs
in the official Linkin Park Vol. 2 DLC music pack with custom community songs from BeatSaver.
...
```
AlreadyOver, Crawling, FightingMyself, InMyHead, Lost, MoreTheVictim, NumbEncore, RememberTheName
```
...
## Target: Linkin Park Vol. 2 Official DLC Pack

- **Pack key**: `linkinpark2`
- **Pack bundle**: `linkinpark2_pack_assets_all_cce8a819387a119f72eb1a3211e6fbb7.bundle`
...
```bash
# 1. Already Over → [YOUR CUSTOM SONG HERE]
...
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target AlreadyOver     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 2. Crawling → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Crawling     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 3. Fighting Myself → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target FightingMyself     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 4. In My Head → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target InMyHead     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 5. Lost → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Lost     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 6. More The Victim → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target MoreTheVictim     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 7. Numb/Encore → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target NumbEncore     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 8. Remember The Name → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target RememberTheName     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```
...
The song slot IDs and difficulty modes for the Linkin Park Vol. 2 pack are defined in:
