# Installing Custom Songs Over the Monstercat Music Pack
...
```
Boundless, EmojiVIP, Epic, FeelingStronger, Overkill, Rattlesnake, Stronger, ThisTime, TillItsOver, WeWontBeAlone
```
...
## Target: Monstercat Official DLC Pack

- **Pack key**: `monstercat`
- **Pack bundle**: `monstercat_pack_assets_all_bc7eacd8b59117ddd4a8bd66402238a6.bundle`
...
```bash
# 1. Boundless → [YOUR CUSTOM SONG HERE]
...
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Boundless     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 2. Emoji VIP → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target EmojiVIP     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 3. EPIC → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Epic     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 4. Feeling Stronger → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target FeelingStronger     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 5. Overkill → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Overkill     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 6. Rattlesnake → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Rattlesnake     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 7. Stronger → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Stronger     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 8. This Time → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target ThisTime     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 9. Till It's Over → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target TillItsOver     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 10. We Won't Be Alone → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target WeWontBeAlone     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```
...
The song slot IDs and difficulty modes for the Monstercat pack are defined in:
