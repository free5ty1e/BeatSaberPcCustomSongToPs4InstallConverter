# Installing Custom Songs Over the Soundtrack Vol. 1 Music Pack

This document provides step-by-step, self-contained pipeline commands to replace all 10 songs
in the official Soundtrack Vol. 1 DLC music pack with custom community songs from BeatSaver.
...
```
100Bills, BalearicPumping, BeatSaber, Breezer, CommercialPumping, CountryRounds, Escape, Legend, LvlInsane, TurnMeOn
```
...
## Target: Soundtrack Vol. 1 Official DLC Pack

- **Pack key**: `ostvol1`
- **Pack bundle**: `ostvol1_pack_assets_all_774a625d0b21a1d013d9b5f1c404c6d3.bundle`
...
```bash
# 1. $100 Bills → [YOUR CUSTOM SONG HERE]
...
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target 100Bills     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 2. Balearic Pumping → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target BalearicPumping     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 3. Beat Saber → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target BeatSaber     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 4. Breezer → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Breezer     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 5. Commercial Pumping → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target CommercialPumping     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 6. Country Rounds → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target CountryRounds     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 7. Escape → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Escape     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 8. Legend → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Legend     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 9. Lvl Insane → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target LvlInsane     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 10. Turn Me On → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target TurnMeOn     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```
...
The song slot IDs and difficulty modes for the Soundtrack Vol. 1 pack are defined in:
