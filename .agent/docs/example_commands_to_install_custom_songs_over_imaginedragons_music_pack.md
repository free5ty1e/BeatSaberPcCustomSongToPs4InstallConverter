# Installing Custom Songs Over the Imagine Dragons Music Pack

This document provides step-by-step, self-contained pipeline commands to replace all 12 songs
in the official Imagine Dragons DLC music pack with custom community songs from BeatSaver.
...
```
BadLiar, Believer, Bones, Digital, Enemy, ItsTime, Machine, Natural, Radioactive, Thunder, Warriors, WhateverItTakes
```
...
## Target: Imagine Dragons Official DLC Pack

- **Pack key**: `imaginedragons`
- **Pack bundle**: `imaginedragons_pack_assets_all_721ae13bcd9ea4fcaa0d618ef57bf14a.bundle`
...
```bash
# 1. Bad Liar → [YOUR CUSTOM SONG HERE]
...
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target BadLiar     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 2. Believer → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Believer     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 3. Bones → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Bones     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 4. Digital → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Digital     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 5. Enemy → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Enemy     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 6. It's Time → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target ItsTime     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 7. Machine → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Machine     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 8. Natural → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Natural     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 9. Radioactive → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Radioactive     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 10. Thunder → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Thunder     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 11. Warriors → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target Warriors     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```

```bash
# 12. Whatever It Takes → [YOUR CUSTOM SONG HERE]
# Custom Song: [Song Name]
# Artist: [Artist Name]
# Album: [Album Name]
# Year: [Year]
...
# BPM: [BPM]
# Difficulties: 5/5 (Easy through Expert+)
python3 tools/full_custom_song_pipeline.py     --download-beat-saver-song REPLACE_MAP_ID     --target WhateverItTakes     --pcm16     --no-pad     --convert-to-v3     --deploy-full
```
...
The song slot IDs and difficulty modes for the Imagine Dragons pack are defined in:
