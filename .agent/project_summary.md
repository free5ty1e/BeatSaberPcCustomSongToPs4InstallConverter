...
**Current Status:** 🔄 v0.14 DEPLOYED — NEW hook approach: restore+call+rehook for open(). No Detour stub/trampoline (bypasses InstructionSize, PC-relative jump, HDE issues). fopen still via Detour (safe). AWAITING TEST.
