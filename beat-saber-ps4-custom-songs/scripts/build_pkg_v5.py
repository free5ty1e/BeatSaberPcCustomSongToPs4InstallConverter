#!/usr/bin/env python3
"""PS4 fPKG Builder v4 - With correct Content ID from working DLC"""
import struct
import hashlib
import datetime
...
# Use SAME Content ID as working DLC
CONTENT_ID = "UP4882-CUSA12878_00-P1S5XXXXXXXXXXXX"
TITLE_ID = "CUSA12878"
GAME_TITLE = "RIOT - Overkill"  # Same as working for now
...
def build_pkg():
    print(f"Building fPKG v5: {GAME_TITLE}")
...
def main():
    ...
    output = OUTPUT_DIR / "custom_songs_v5.pkg"
