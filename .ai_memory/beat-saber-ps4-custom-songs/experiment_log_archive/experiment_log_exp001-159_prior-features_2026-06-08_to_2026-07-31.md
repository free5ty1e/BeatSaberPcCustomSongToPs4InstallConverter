---
name: experiment-log-archive-prior-features
description: "Archived experiments 1-159 covering prior features: song replacement pipeline, plugin foundation, FSELF/redirects, song metadata replacement (TMP/MoveNext hooks), CI/CD, Camellia pack. Superseded by the per-feature rotation rule."
metadata:
  node_type: memory
  type: reference
---

# Experiment Log ARCHIVE: Prior Features (Exp 1-159)

**Feature scope:** Pre-Beatmap-Mode-Mapping work:
- Plugin foundation: heartbeat tests, FSELF format discovery, file redirects (open() hook)
- Dynamic redirect config (`redirects.json`) & rich song database (305 songs)
- Song name/artist metadata replacement (TMP_Text hooks, MoveNext() data-source hook, v0.8027-v0.8040)
- CI/CD infrastructure (v0.5304-v0.5306) and Camellia Music Pack replacement

**Archived:** 2026-08-01 (per-feature experiment log rotation rule — see CLAUDE.md / .opencode/rules.md §1)
**Next active log:** `../experiment_log.md` → **Beatmap Mode Mapping** (Exp 160+)
